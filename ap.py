...
def main():
    ...
    # FIX APPLIED HERE: Removed ** and used <b> for bolding within the HTML string.
    ...
    if uploaded_file is not None:
        ...
        # NOTE: This uses the custom CSS class .bold-white-text, which overrides the background/error box colors
